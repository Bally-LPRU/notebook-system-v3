/**
 * Migration Script: Add Denormalized Data to Existing Loan Requests (Client SDK Version)
 * 
 ...
 * 
 * Usage:
 *   node scripts/migrate-loan-request-denormalization-client.js
 */
...
async function migrateLoanRequests() {
  console.log('🔄 Starting loan request denormalization migration...\n');
